...
$current_day_string = $year."-".$month."-".$day;
$current_day_sec = strtotime($current_day_string);
$week_start_sec = $current_day_sec - 86400*$numday;
$week_end_sec = $week_start_sec + 86400*6;     
$week_start1 = date("Y-m-d", $week_start_sec); 
$week_end1 =  date("Y-m-d", $week_end_sec);    
